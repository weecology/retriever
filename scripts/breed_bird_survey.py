...
class main(Script):
    def __init__(self, **kwargs):
        ...
        self.citation = (
            "Pardieck, K.L., D.J. Ziolkowski Jr., M.-A.R. Hudson. "
    ...
    def download(self, engine=None, debug=False):
        try:
            ...
            # Species table
            table = Table("species", cleanup=Cleanup(), contains_pk=True, header_rows=9)
            ...
            engine.auto_create_table(
                Table("routes", cleanup=Cleanup()), filename="routes.csv"
            )
            ...
            engine.auto_create_table(
                Table("weather", pk="RouteDataId", cleanup=self.cleanup_func_table),
            ...
            # Region_codes table
            table = Table(
                "region_codes", pk=False, header_rows=11, fixed_width=[11, 11, 30]
            )
            ...
            stateslist = [
                ...
                "Nebraska",
                "Nevada",
                ["New Hampshire", "NHampsh"],
                ["New Jersey", "NJersey"],
                ["New Mexico", "NMexico"],
                ["New York", "NYork"],
                ["North Carolina", "NCaroli"],
                ["North Dakota", "NDakota"],
                "Ohio",
                "Oklahoma",
                "Oregon",
                "Pennsylvania",
                ["Rhode Island", "RhodeIs"],
                ["South Carolina", "SCaroli"],
                ...
                "Virginia",
                "Washington",
                ["West Virginia", "W_Virgi"],
                "Wisconsin",
                "Wyoming",
                "Alberta",
                ["British Columbia", "BritCol"],
                "Manitoba",
                ["New Brunswick", "NBrunsw"],
                ["Northwest Territories", "NWTerri"],
                "Newfoundland",
                ["Nova Scotia", "NovaSco"],
                "Nunavut",
                "Ontario",
            ...
            for state in stateslist:
                try:
                    ...
                    try:
                        ...
                        print(
                            "Failed bulk insert on " + state + ", inserting manually."
                        )
