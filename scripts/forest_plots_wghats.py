...
class main(Script):
    def __init__(self, **kwargs):
        ...
        self.title = (
            "Indian Forest Stand Structure and Composition (Ramesh et al. 2010)"
        )
        self.name = "forest-plots-wghats"
        self.retriever_minimum_version = "2.0.dev"
        self.version = "1.3.2"
        self.ref = (
            "https://figshare.com/collections/Forest_stand_structure_and_composition_in_96_sites_"
        ...
        self.citation = (
            "B. R. Ramesh, M. H. Swaminath, Santoshgouda V. Patil, Dasappa, Raphael Pelissier, P. "
        ...
        self.description = (
            "This data set reports woody plant species abundances in a network of 96 sampling "
    ...
    def download(self, engine=None, debug=False):
        ...
        engine.download_files_from_archive(self.urls["data"], files)

        # Create table species
        engine.auto_create_table(
            Table("species", cleanup=self.cleanup_func_table),
        ...
        # Create table sites
        engine.auto_create_table(
            Table("sites", cleanup=self.cleanup_func_table),
