...
SCRIPT = BasicTextTemplate(tables={'MOM': Table('MOM', cleanup=Cleanup(correct_invalid_value, nulls=['-999']),columns=[('record_id', ('pk-auto',)), ('continent', ('char', '7')), ('status', ('char', '7')), ('sporder', ('char', '20')), ('family', ('char', '20')), ('genus', ('char', '20')), ('species', ('char', '20')), ('log_mass_g', ('double',)), ('comb_mass_g', ('double',)), ('reference', ('char', '10'))])},
