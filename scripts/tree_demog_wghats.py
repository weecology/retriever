...
class main(Script):
    def __init__(self, **kwargs):
        ...
        self.name = "Tree demography in Western Ghats, India - Pelissier et al. 2011"
        self.shortname = "tree-demog-wghats"
        ...
        self.tags = ["plants", "time-series", "observational"]
    ...
    def download(self, engine=None, debug=False):
        ...
        engine.auto_create_table(Table('sp_list', cleanup=Cleanup(correct_invalid_value, nulls=['NA'])),
        ...
        engine.auto_create_table(Table('ind_loc_girth', cleanup=Cleanup(correct_invalid_value, nulls=['NA'])),
